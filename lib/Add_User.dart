...
import 'package:crud/Model/adduserModel.dart';
...
class _Add_UserState extends State<Add_User> {
  ...
  String imgUrll ="https://uxwing.com/wp-content/themes/uxwing/download/peoples-avatars/default-profile-picture-male-icon.png";
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                ...
                collection("users").
                doc(email.text).
                set(adduserModel(name: name.text, email: email.text, password: password.text).toMap());
                Navigator.pop(context);
              },
            child: Container(
              height: w * 0.13,
